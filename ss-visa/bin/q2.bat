...
@rem 
set DEFAULT_JVM_OPTS=-server -Dappname=jPTS %DEFAULT_JVM_OPTS%
set JAVA_OPTS=-Ddb.create.enabled=YES %JAVA_OPTS%
...
@rem Execute run
CD "%APP_HOME%"
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %RUN_OPTS% -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=2050 -jar ss-visa-1.14.0.jar %CMD_LINE_ARGS%
